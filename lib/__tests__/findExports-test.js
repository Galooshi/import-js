...
describe('useUnsafeRequireParsing', () => {
  it('get exports in ifStatement', () => {
    expect(findExports(
      'if (true) module.exports = "unless conten";',
      // require will load 'requireMockFile' file
      'requireMockFile',
      true,
    )).toEqual({
      named: ['testEnv'],
