...
describe('Configuration', () => {
  ...
  describe('#get()', () => {
    ...
    describe('with appliesFrom', () => {
      ...
      it('uses local config when pathToImportedModule matches appliesFrom', () => {
        const configuration = new Configuration('goo/gar/gaz.js');
        const opts = { pathToImportedModule: 'from/hello.js' };
        expect(configuration.get('declarationKeyword', opts)).toEqual('var');
      });

      it('uses global config when pathToImportedModule does not match appliesFrom', () => {
        const configuration = new Configuration('goo/gar/gaz.js');
        const opts = { pathToImportedModule: 'not_from/hello.js' };
