...
describe('Configuration', () => {
  ...
  describe('#get()', () => {
    it('has default values', () => {
      ...
      expect(configuration.get('stripFileExtensions')).toEqual([
        '.js',
        '.jsx',
        '.ts',
        '.tsx',
    ...
    describe('with a javascript configuration file in home directory', () => {
      ...
      describe('and a project javascript configuration file', () => {
        ...
        it('prefers project file', () => {
          expect(new Configuration().get('declarationKeyword')).toEqual(
            'import',
          );
        });
      });
    ...
    describe('with a javascript configuration file', () => {
      describe('that will not parse', () => {
        let originalReadJsFile;
        beforeEach(() => {
          originalReadJsFile = FileUtils.readJsFile;
          FileUtils.readJsFile = jest.fn(() => {
            throw new Error('Syntax error');
          });
        });

        afterEach(() => {
          FileUtils.readJsFile = originalReadJsFile;
        });
      ...
      describe('with user defined globals', () => {
        ...
        describe('with mergableOptions.globals set to false', () => {
          ...
          it('returns only user globals', () => {
            expect(new Configuration().get('globals')).toEqual(['FOO', 'bar']);
          });
        });
      });
    });
