...
describe('ImportStatements', () => {
  ...
  it('returns all of the pushed import statements', () => {
    const statements = new ImportStatements(new Configuration());
    const statementA = ImportStatement.parse("import foo from 'foo';");
    const statementB = ImportStatement.parse("import bar from 'bar';");
    statements.push(statementA, statementB);
