...
describe('ImportStatements', () => {
  ...
  describe('with a package dependency', () => {
    beforeEach(() => {
      require('../FileUtils').__setJsonFile('package.json', {
        dependencies: {
          bar: '1.0.0',
        },
      });
    ...
    afterEach(() => {
      require('../FileUtils').__setJsonFile('package.json', null);
    });
    ...
    describe('with a node environment', () => {
      beforeEach(() => {
        require('../FileUtils').__setJsonFile('.importjs.json', {
          environments: ['node'],
        });
      });

      afterEach(() => {
        require('../FileUtils').__setJsonFile('.importjs.json', null);
      });
