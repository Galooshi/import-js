...
describe('Importer', () => {
  ...
  beforeEach(() => {
    ...
    configuration = {
      lookupPaths: [path.basename(tmpDir)],
    };
  ...
  describe('#import', () => {
    ...
    describe('when lookupPaths is just an empty string', () => {
      beforeEach(() => {
...
goo
        ...
        describe('with an appliesFrom pattern', () => {
          beforeEach(() => {
            configuration = Object.assign(configuration, {
              appliesFrom: 'tmp/bar/**/*', // TODO: Is there a bug here?
              declarationKeyword: 'var',
...
goo
            ...
            describe('when using `.` as lookup_path', () => {
              beforeEach(() => {
                // TODO this is an invalid configuration option
                configuration.lookupPath = ['.'];
              });
