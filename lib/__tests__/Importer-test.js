  ...
  describe('#import', () => {
    ...
    beforeEach(() => {
      subject = () => {
        ...
        new Importer(editor).import(word);
...
foo
      ...
      describe('when the same logical file is matched twice', () => {
        ...
        it('does not list logical duplicates', () => {
          subject();
          expect(editor._unresolvedImports[0].alternatives).toEqual([
  ...
  describe('#rewriteImports', () => {
    ...
    beforeEach(() => {
      ...
      subject = () => {
        ...
        new Importer(editor).rewriteImports();
        return editor.currentFileContent();
      };
    });
  ...
  describe('#goto', () => {
    ...
    beforeEach(() => {
      subject = () => {
        ...
        return new Importer(editor).goto(word);
      };
    });
    ...
    describe('with a variable name that matches multiple files', () => {
      ...
      describe('when the variable has not been previously imported', () => {
        it('displays a message about selecting a module', () => {
          subject();
          expect(editor._unresolvedImports[0]).toEqual({
            word: 'foo',
            alternatives: [
              'bar/foo',
              'car/foo',
