...
describe('Importer', () => {
  ...
  beforeEach(() => {
    ...
    setup = () => {
      ...
      let error;
      let done = false;
      moduleFinder.handleFilesAdded(existingFiles.map((f) => ({
        path: f,
        mtime: Date.now(),
      }))).then(() => {
        done = true;
...
BarFooTa
        ...
        describe('when the last folder end with "s"', () => {
          beforeEach(() => {
            existingFiles = ['sko/bar/foos/ta.jsx'];
          });

          it('resolves the import', () => {
            expect(subject()).toEqual(`
import BarFooTa from './sko/bar/foos/ta';
...
BarFooTa
          ...
          describe('when the variable also has "s"', () => {
            ...
            it('resolves the import', () => {
              expect(subject()).toEqual(`
import FoosTa from './sko/bar/foos/ta';
...
FoosTa
        ...
        describe('when the folders end with "es"', () => {
          beforeEach(() => {
            existingFiles = ['sko/buses/ta.jsx'];
            word = 'skoBusTa';
            text = 'skoBusTa';
          });
          ...
          it('resolves the import', () => {
            expect(subject()).toEqual(`
import skoBusTa from './sko/buses/ta';
...
skoBusTa
          ...
          describe('when the variable also has "es"', () => {
            ...
            it('resolves the import', () => {
              expect(subject()).toEqual(`
import BusesTa from './sko/buses/ta';
...
foo
      ...
      describe('with an importStatementFormatter that manipulates the path', () => {
        beforeEach(() => {
