  ...
  beforeEach(() => {
    ...
    setup = () => {
      ...
      moduleFinder.handleFilesAdded(existingFiles.map((f) => ({
        ...
        moduleFinder.handleFilesAdded(packageDependencies.map((dep) => ({
          path: normalizePath(path.join('node_modules', dep, `${dep}-main.jsx`), process.cwd()),
          mtime: Date.now(),
          alias: dep,
        })))
      ).then(() => {
...
foo
        ...
        describe('matching a package dependency', () => {
          ...
          it('opens the package main file', () => {
            expect(subject()).toEqual(path.join(process.cwd(),
    ...
    describe('with a variable name matching an alias', () => {
      ...
      describe('to an absolute resource', () => {
        ...
        it('opens the alias main file', () => {
          expect(subject()).toEqual(path.join(process.cwd(),
            'node_modules/stylez/stylez-main.jsx'));
        });
      });
    });
