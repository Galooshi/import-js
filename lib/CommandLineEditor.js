...
class CommandLineEditor {
  ...
  /**
   * Record a variable that has multiple mathing modules
   *
   * @param {String} word The word/variable to import
   * @param {Array<Object>} alternatives A list of alternatives
   */
  addUnresolvedImport(word, alternatives) {
    this._unresolvedImports[word] = alternatives;
  }
}
