...
class JsModule {
  /**
   * @param {String} lookup_path the lookup path in which this module was found
   * @param {String} relativeFilePath a full path to the file, relative to
   *   the project root.
   * @param {Array} stripFileExtensions a list of file extensions to strip,
   *   e.g. ['.js', '.jsx']
   * @param {String|null} makeRelativeTo a path to a different file which the
