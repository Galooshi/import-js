...
class ImportStatements {
  // @param {ImportJS::Configuration} config
  // @param {Hash} imports
  ...
  // @param {ImportJS::ImportStatement} import_statement
  ...
  // @param {ImportJS::ImportStatement} import_statement
  // @param {Array<String>} package_dependencies
  // @param {Array<String>} core_modules
  // @return {Number}
