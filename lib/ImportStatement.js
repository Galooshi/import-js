...
class ImportStatement {
  ...
  /**
   * @param {Object} opts
   * @param {String} opts.assignment
   * @param {String} opts.declarationKeyword
   * @param {String} opts.defaultImport
   * @param {String} opts.importFunction
   * @param {String} opts.namedImports
   * @param {String} opts.originalImportString
   ...
   */
  variables() {
    return [this.defaultImport, ...(this.namedImports || [])].filter(v => v);
  }

  /**
   * @param {Number} maxLine_length where to cap lines at
   * @param {String} tab e.g. '  ' (two spaces)
   ...
   * @param {ImportStatement} import_statement
   */
  ...
  /**
   * @param {String} line
   * @param {Number} max_line_length where to cap lines at
   * @return {Boolean}
   */
