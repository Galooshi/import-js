...
function findJsModulesFromModuleFinder(
  ...
  return new Promise((resolve: Function, reject: Function) => {
    ...
    if (!config.get('importDevDependencies')) {
      ...
      isWantedPackageDependency = (packageName: string): boolean => packageDependencies.has(packageName);
    }
...
export function dedupeAndSort(modules: Array<JsModule>): Array<JsModule> {
  ...
  return sortBy(uniques, (module: JsModule): string => [module.importPath, module.hasNamedExports ? 1 : 0].join());
}
